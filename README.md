...
├── ingestion/                     # UCC filing data ingestion pipeline
│   ├── adapters/                  # Data source adapters (Socrata, state bulk, commercial)
│   ├── config.py                  # State-source mapping, costs, schedules
│   ├── models.py                  # UCCFiling model + SQLite storage layer
│   ├── normalizer.py              # Field normalization across formats
...
│   ├── ingestion_plan.md          # UCC data ingestion rollout plan
