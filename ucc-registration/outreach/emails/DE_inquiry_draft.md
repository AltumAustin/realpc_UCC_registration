# Delaware UCC Authorized Searcher Inquiry — DRAFT
...
1. **Application Process:** Is there a formal application process to become an Authorized UCC Searcher? If so, could you provide the application form or direct me to where it can be obtained?

2. **Eligibility Requirements:** What are the specific requirements for certification? We understand that Authorized Searchers are typically Registered Agents, Service Companies, or Law Firms — does our company's profile as a financial technology company meet the eligibility criteria?

3. **New Applications:** Is the Division currently accepting new applications for Authorized Searcher certification?

4. **Documentation:** What documentation is required as part of the application (e.g., Certificate of Good Standing, proof of insurance, background checks, technology certifications)?

5. **Fees and Timeline:** What are the associated fees and estimated processing time for the application?
